...
class Frame(wx.Frame):
    ...
    #----------------------------------------------------------------------
    def __init__(self, parent, id, title, mp):
        ...
        self.mp = mpc.mpCtrl(self.panel, -1, mp)
        ...
        mainSizer.Add(self.mp, 1, wx.ALL|wx.EXPAND, 5)
    ...
    def on_add_file(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.mp.Loadfile(trackPath)
 
            t_len = self.mp.GetTimeLength()
    ...
    def on_set_volume(self, event):
        ...
        self.mp.SetProperty("volume", self.currentVolume)
